...
private:
    ...
    float theta = 0.0f;        // angolo di rotazione del triangolo
    ...
    void drawFrame()
    {
        ...
        theta += 0.01f; // incrementa l'angolo di rotazione del triangolo
        if (theta > 360.0f)
        {
            theta = 0.0f; // resetta l'angolo di rotazione del triangolo
        }
